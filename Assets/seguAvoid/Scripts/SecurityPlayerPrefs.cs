...
public class SecurityPlayerPrefs
{
    ...
    {
        // 8 바이트로 하고, 변경해서 쓸것
        byte[] saltBytes = new byte[] { 72, 59, 91, 30, 89, 96, 64, 95 };

        // 길이 상관 없고, 키를 만들기 위한 용도로 씀
        string randomSeedForKey = "5b6fcb4aaa0a42acae649eba45a506eca6s5d4f54as4df52sf4as8d4f3s2d1fasg94h4a5sd4";

        // 길이 상관 없고, aes에 쓸 key 와 iv 를 만들 용도
        string randomSeedForValue = "2e327725789841b5bb5c706d6b2ad897g3hj4khj96k44841gh1j32er4gasr4g9g64af6adsg4";
